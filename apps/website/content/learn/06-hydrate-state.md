...
```ts
// @source examples/learn-6/src/Counter.ts#L14-L23
...
The server handoff is complete. For adoption diagnostics, consult [hydrating Typed HTML](/explore/hydrating-typed-html).
