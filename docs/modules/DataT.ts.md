...
) => <R2, B>(fab: Kind3<F, R2, E, D.Data<(a: A) => B>>) => Kind3<F, ApplyVariance<F, 'R', [R1, R2]>, E, D.Data<B>>
...
export declare function ap<F extends URIS2, E>(
  F: Apply.Apply2C<F, E>
): <A>(fa: Kind2<F, E, D.Data<A>>) => <B>(fab: Kind2<F, E, D.Data<(a: A) => B>>) => Kind2<F, E, D.Data<B>>
export declare function ap<F extends URIS2>(
  F: Apply.Apply2<F>
): <E1, A>(
  fa: Kind2<F, E1, D.Data<A>>
) => <E2, B>(fab: Kind2<F, E2, D.Data<(a: A) => B>>) => Kind2<F, ApplyVariance<F, 'E', [E1, E2]>, D.Data<B>>
...
): <A>(onNoData: () => A, onLoading: (progress: O.Option<Progress>) => A) => (ma: Kind<F, D.Data<A>>) => Kind<F, A>
export declare function getOrElse<F>(
  F: Functor.Functor<F>
): <A>(onNoData: () => A, onLoading: (progress: O.Option<Progress>) => A) => (ma: HKT<F, D.Data<A>>) => HKT<F, A>
```
...
export declare function map<F extends URIS4>(
  F: Functor.Functor4<F>
): <A, B>(f: (a: A) => B) => <S, R, E>(fa: Kind4<F, S, R, E, D.Data<A>>) => Kind4<F, S, R, E, D.Data<B>>
...
```ts
export declare function fromProgress<F extends URIS4, S = Initial<F, 'S'>, R = Initial<F, 'R'>, E = Initial<F, 'E'>>(
  P: Pointed4<F>
): (progress: Progress) => Kind4<F, S, R, E, D.Loading>
...
```ts
export declare function loading<F extends URIS4, S = Initial<F, 'S'>, R = Initial<F, 'R'>, E = Initial<F, 'E'>>(
  P: Pointed4<F>
): Kind4<F, S, R, E, D.Loading>
...
```ts
export declare function noData<F extends URIS4, S = Initial<F, 'S'>, R = Initial<F, 'R'>, E = Initial<F, 'E'>>(
  P: Pointed4<F>
): Kind4<F, S, R, E, D.NoData>
...
export declare function replete<F extends URIS4>(
  P: Pointed4<F>
): <A, S = Initial<F, 'S'>, R = Initial<F, 'R'>, E = Initial<F, 'E'>>(value: A) => Kind4<F, S, R, E, D.Replete<A>>
...
) => Kind3<F, ApplyVariance<F, 'R', [R1, R2, R3, R4, R5]>, ApplyVariance<F, 'E', [E1, E2, E3, E4, E5]>, A>
...
) => Kind3<F, ApplyVariance<F, 'R', [R1, R2, R3, R4, R5]>, ApplyVariance<F, 'E', [E1, E2, E3, E4, E5]>, A | B | D | E>
...
) => <E5>(data: Kind2<F, E5, D.Data<C>>) => Kind2<F, ApplyVariance<F, 'E', [E1, E2, E3, E4, E5]>, A | B | D | E>
