...
*Defined in [src/logic/all.ts:12](https://github.com/TylorS/typed-fp/blob/f129829/src/logic/all.ts#L12)*
...
*Defined in [src/logic/all.ts:17](https://github.com/TylorS/typed-fp/blob/f129829/src/logic/all.ts#L17)*
