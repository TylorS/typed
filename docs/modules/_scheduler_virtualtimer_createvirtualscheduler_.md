...
*Defined in [src/Scheduler/VirtualTimer/createVirtualScheduler.ts:8](https://github.com/TylorS/typed-fp/blob/ac98ca1/src/Scheduler/VirtualTimer/createVirtualScheduler.ts#L8)*
