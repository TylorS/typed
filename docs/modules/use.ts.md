...
```ts
export declare const useEq: <A = void>(Eq?: Eq<A>, initial?: boolean) => (value: A) => E.Env<Ref.Set & Ref.Get, boolean>
```
...
export declare const useKeyedRefs: <A>(
  ...
  Ref.Refs,
  { readonly findRefs: (value: A) => E.Env<unknown, Ref.Refs>; readonly deleteRefs: (value: A) => S.Disposable }
>
```
...
export declare const useReaderStream: <A = void, B = unknown>(
  ...
  dep: A
) => E.Env<E & Ref.Get & Ref.Has & Ref.Set & Ref.Remove & Ref.Events & Ref.ParentRefs & SchedulerEnv, O.Option<C>>
```
...
) => RS.ReaderStream<E1 & Ref.Get & Ref.Has & Ref.Set & Ref.Remove & Ref.Events & Ref.ParentRefs & E2, readonly B[]>
```
...
export declare const useRefsStream: <A, E1, B>(
  ...
  stream: RS.ReaderStream<E2, readonly A[]>
) => RS.ReaderStream<E1 & E2 & Ref.Get & Ref.Has & Ref.Set & Ref.Remove & Ref.Events & Ref.ParentRefs, readonly B[]>
```
...
export declare const useStream: <A = void>(
  ...
  stream: S.Stream<B>,
  dep: A
) => E.Env<Ref.Get & Ref.Has & Ref.Set & Ref.Remove & Ref.Events & Ref.ParentRefs & SchedulerEnv, O.Option<B>>
```
