...
export const takeOneIfNotDomEnvironment: <A, E, R>(
  fx: RefSubject.RefSubject<A, E, R>
) => RefSubject.RefSubject<A, E, R | CurrentEnvironment> = takeOneIfNotEnvironment(["dom", "test:dom"])
...
export const takeOneIfNotServerEnvironment: <A, E, R>(
  fx: RefSubject.RefSubject<A, E, R>
) => RefSubject.RefSubject<A, E, CurrentEnvironment | R> = takeOneIfNotEnvironment(["server", "test:server"])
...
export const takeOneIfNotStaticEnvironment: <A, E, R>(
  fx: RefSubject.RefSubject<A, E, R>
) => RefSubject.RefSubject<A, E, CurrentEnvironment | R> = takeOneIfNotEnvironment(["static", "test:static"])
