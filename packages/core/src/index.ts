/**
 * @typed/core serves as a prelude to the essential @typed packages for building front-end web applications
 * in Effect. It further provides a set more opinionated abstractions for how these libraries can be used
 * composed together.
 *
 * @since 1.0.0
 */
