...
export const uniqueSymbol = <S extends symbol>(symbol: S, annotations?: Record<string | symbol, unknown> | undefined) =>
...
export const instanceOf = <A extends abstract new(...args: any) => any>(
  constructor: A,
  options?: S.DocAnnotations<object>
): SchemaDecoder<InstanceType<A>> => fromSchema(S.instanceOf(constructor, options))
