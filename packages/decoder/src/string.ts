...
export const minLength =
  (min: number) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> => (i, options) =>
...
export const maxLength =
  (max: number) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> => (i, options) =>
    ParseResult.flatMap(decoder(i, options), (s) =>
      s.length <= max
        ? ParseResult.success(s)
        : stringFailure(`Expected string to have a maximum length of ${max}, got ${s.length}`, s))

export const length = (length: number) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> =>
  pipe(decoder, minLength(length), maxLength(length))

export const nonEmpty = minLength(1)

export const startsWith =
  (prefix: string) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> => (i, options) =>
    ParseResult.flatMap(decoder(i, options), (s) =>
      s.startsWith(prefix)
        ? ParseResult.success(s)
...
export const endsWith =
  (suffix: string) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> => (i, options) =>
    ParseResult.flatMap(decoder(i, options), (s) =>
      s.endsWith(suffix)
        ? ParseResult.success(s)
...
export const includes =
  (substring: string) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> => (i, options) =>
    ParseResult.flatMap(decoder(i, options), (s) =>
...
export const pattern =
  (regex: RegExp) => <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, O> => (i, options) =>
    ParseResult.flatMap(
      decoder(i, options),
      (s) => regex.test(s) ? ParseResult.success(s) : stringFailure(`Expected string to match ${regex}, got ${s}`, s)
    )

export const trimmed = <I, O extends string>(decoder: Decoder<I, O>): Decoder<I, string> => (i, options) =>
