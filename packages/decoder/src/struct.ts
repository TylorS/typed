...
export function struct<P extends ReadonlyRecord<Decoder<unknown, any>>>(properties: P): StructDecoder<P> {
  return Object.assign(
    (i: InputOf<StructDecoder<P>>, options?: ParseOptions) =>
      Effect.gen(function*($) {
        ...
        if (ReadonlyArray.isNonEmptyReadonlyArray(failures)) {
...
export const pick =
  <P extends ReadonlyRecord<Decoder<any, any>>, Keys extends ReadonlyArray<keyof P>>(...keys: Keys) =>
...
type PickFlatten<P extends ReadonlyRecord<Decoder<any, any>>, Keys extends ReadonlyArray<keyof P>> = Flatten<
  Pick<P, Keys[number]>
>

type OmitFlatten<P extends ReadonlyRecord<Decoder<any, any>>, Keys extends ReadonlyArray<keyof P>> = Flatten<
  Omit<P, Keys[number]>
>
