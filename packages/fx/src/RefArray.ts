...
export const dropWhile: {
  (predicate: (a: unknown) => boolean): <E, A>(ref: RefArray<E, A>) => Effect.Effect<never, E, ReadonlyArray<A>>
  <E, A>(ref: RefArray<E, A>, predicate: (a: unknown) => boolean): Effect.Effect<never, E, ReadonlyArray<A>>
} = dual(2, function dropWhile<E, A>(ref: RefArray<E, A>, predicate: (a: unknown) => boolean) {
...
export const filterValues: {
  ...
  <E, A>(ref: RefArray<E, A>, predicate: (a: A) => boolean): Computed.Computed<never, E, ReadonlyArray<A>>
...
export const groupBy: {
  <A>(f: (a: A) => string): <E>(ref: RefArray<E, A>) => Computed.Computed<never, E, Record<string, ReadonlyArray<A>>>
  <E, A>(ref: RefArray<E, A>, f: (a: A) => string): Computed.Computed<never, E, Record<string, ReadonlyArray<A>>>
...
export const insertAt: {
  <A>(index: number, a: A): <E>(ref: RefArray<E, A>) => Effect.Effect<never, E, ReadonlyArray<A>>
  <E, A>(ref: RefArray<E, A>, index: number, a: A): Effect.Effect<never, E, ReadonlyArray<A>>
 ...
 * @category computed
 */
export const isNonEmpty = <E, A>(ref: RefArray<E, A>): Computed.Computed<never, E, boolean> =>
  ref.map(ReadonlyArray.isNonEmptyReadonlyArray)
 ...
 */
export const map: {
  <A>(f: (a: A, index: number) => A): <E>(ref: RefArray<E, A>) => Computed.Computed<never, E, ReadonlyArray<A>>
  <E, A>(ref: RefArray<E, A>, f: (a: A, index: number) => A): Computed.Computed<never, E, ReadonlyArray<A>>
...
export const mapValues: {
  <A, B>(f: (a: A, index: number) => B): <E>(ref: RefArray<E, A>) => Computed.Computed<never, E, ReadonlyArray<B>>
  <E, A, B>(ref: RefArray<E, A>, f: (a: A, index: number) => B): Computed.Computed<never, E, ReadonlyArray<B>>
} = dual(2, function mapValues<E, A, B>(ref: RefArray<E, A>, f: (a: A, index: number) => B) {
...
export const modifyAt: {
  <A>(index: number, f: (a: A) => A): <E>(ref: RefArray<E, A>) => Effect.Effect<never, E, ReadonlyArray<A>>
  <E, A>(ref: RefArray<E, A>, index: number, f: (a: A) => A): Effect.Effect<never, E, ReadonlyArray<A>>
...
export const partition: {
  <A, B extends A>(
    predicate: (a: A) => a is B
  ): <E>(ref: RefArray<E, A>) => Computed.Computed<never, E, readonly [ReadonlyArray<B>, ReadonlyArray<A>]>
...
} = dual(3, function reduce<E, A, B>(ref: RefArray<E, A>, b: B, f: (b: B, a: A, index: number) => B) {
...
export const reduceRight: {
  <A, B>(b: B, f: (b: B, a: A, index: number) => B): <E>(ref: RefArray<E, A>) => Computed.Computed<never, E, B>
  <E, A, B>(ref: RefArray<E, A>, b: B, f: (b: B, a: A, index: number) => B): Computed.Computed<never, E, B>
} = dual(3, function reduceRight<E, A, B>(ref: RefArray<E, A>, b: B, f: (b: B, a: A, index: number) => B) {
 ...
 */
export const sortBy: {
  <A>(orders: Iterable<Order.Order<A>>): <E>(ref: RefArray<E, A>) => Effect.Effect<never, E, ReadonlyArray<A>>
  <E, A>(ref: RefArray<E, A>, orders: Iterable<Order.Order<A>>): Effect.Effect<never, E, ReadonlyArray<A>>
...
export const takeWhile: {
  (predicate: (a: unknown) => boolean): <E, A>(ref: RefArray<E, A>) => Effect.Effect<never, E, ReadonlyArray<A>>
  <E, A>(ref: RefArray<E, A>, predicate: (a: unknown) => boolean): Effect.Effect<never, E, ReadonlyArray<A>>
} = dual(2, function takeWhile<E, A>(ref: RefArray<E, A>, predicate: (a: unknown) => boolean) {
