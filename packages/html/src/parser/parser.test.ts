...
describe(Parser.name, () => {
  ...
  it('parses a simple template', () => {
    ...
    const expected = new Template([new ElementNode('div', [], [])])
  ...
  it('parses class name attributes with holes', () => {
    ...
    const expected = new Template([new ElementNode('div', [new ClassNamePartNode(0)], [])])
  ...
  it('parses a template with children', () => {
    ...
    const expected = new Template([new ElementNode('div', [], [new ElementNode('span', [], [])])])
  ...
  it('parser a template with data attributes', () => {
    ...
    const expected = new Template([new ElementNode('div', [new AttrPartNode('data-foo', 0)], [])])
  ...
  it('parses a template with .data property', () => {
    ...
    const expected = new Template([new ElementNode('div', [new DataNode(0)], [])])
  ...
  it('parses a template with @ event attributes', () => {
    ...
    const expected = new Template([new ElementNode('div', [new EventNode('click', 0)], [])])
  ...
  it('parses nested templates', () => {
    ...
    const expected = new Template([new ElementNode('div', [], [new NodePart(0)])])
  ...
  it('parses properties', () => {
    ...
    const expected = new Template([new ElementNode('div', [new PropertyNode('foo', 0)], [])])
  ...
  it('parse ref attributes', () => {
    ...
    const expected = new Template([new ElementNode('div', [new RefNode(0)], [])])
  ...
  it('parses text-only nodes', () => {
    ...
    const expected = new Template([new TextOnlyElement('textarea', [], [new TextNode('foo')])])
  ...
  it('parses text-only nodes with holes', () => {
    const template = h`<textarea>${'foo'}</textarea>`
    const expected = new Template([new TextOnlyElement('textarea', [], [new TextPartNode(0)])])
  ...
  it('parses self-closing elements', () => {
    ...
    const expected = new Template([new SelfClosingElementNode('input', [])])
  ...
  it('parses self-closing elements with attributes and class names', () => {
    ...
    const expected = new Template([
      new SelfClosingElementNode('input', [new AttrPartNode('type', 0), new ClassNamePartNode(1)]),
    ])
