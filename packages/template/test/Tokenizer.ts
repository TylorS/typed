...
const testCases: Array<TestCase> = [
  ...
  },
  {
    ...
    expected: [
      ...
      new PartToken(0),
      new RefAttributeEndToken(),
      new AttributeToken("class", "cursor-pointer hidden md:flex md:items-center "),
      new EventAttributeStartToken("click"),
      new PartToken(1),
      new EventAttributeEndToken("click"),
      ...
      new AttributeToken(
        "class",
        "bg-light-gray rounded-full flex mr-2 min-w-8 max-h-8 max-w-8 p-2 items-center justify-center overflow-hidden"
      ),
      new OpeningTagEndToken("div"),
      new TextToken("\n        "),
      new PartToken(3),
      ...
      new TextToken("\n\n      "),
      new OpeningTagToken("p"),
      new AttributeToken("class", "text-center whitespace-nowrap"),
      new OpeningTagEndToken("p"),
      new PartToken(4),
      new TextToken(" "),
      new PartToken(5),
      new ClosingTagToken("p"),
      new TextToken("\n\n      "),
      new OpeningTagToken("img"),
      new ClassNameAttributeStartToken(),
      new PartToken(6),
      new ClassNameAttributeEndToken(),
      new AttributeStartToken("src"),
      new PartToken(7),
      new AttributeEndToken("src"),
      new AttributeToken("alt", "Open"),
      new OpeningTagEndToken("img"),
      new TextToken("\n\n      "),
      new OpeningTagToken("div"),
      new AttributeToken("class", "relative"),
      new OpeningTagEndToken("div"),
      new TextToken("\n        "),
      new PartToken(8),
      new TextToken("\n      "),
...
function runTest(test: TestCase) {
  const actual: Array<Token> = Array.from(tokenize(test.template))
