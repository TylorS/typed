...
export function renderCauseToSequential(cause: Cause, renderer: Renderer): Sequential {
  switch (cause.type) {
    case 'Disposed':
...
export function linearSegments(cause: Cause, renderer: Renderer): readonly Step[] {
  switch (cause.type) {
    case 'Then':
...
export function parrallelSegments(cause: Cause, renderer: Renderer): readonly Sequential[] {
  switch (cause.type) {
    case 'Both':
      return [
...
export function prettyLines(cause: Cause, renderer: Renderer): Lines {
...
export function prettyPrint(cause: Cause, renderer: Renderer = defaultRenderer): string {
