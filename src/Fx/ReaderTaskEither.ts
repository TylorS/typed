...
import { Provide3, ProvideAll3, ProvideSome3, UseAll3, UseSome3 } from '@fp/Provide'
import * as E from '@fp/ReaderTaskEither'
...
export const asks = FxT.fromNaturalTransformation(E.FromReader.fromReader)
...
export const Do = flow(doReaderTaskEither, toReaderTaskEither)
