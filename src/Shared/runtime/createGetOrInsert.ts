...
export function createGetOrInsert<F extends URIS2>(
  M: Monad2<F>,
): <A, B, E>(map: Map<A, B>, key: A, insert: Kind2<F, E, B>) => Kind2<F, E, B>

export function createGetOrInsert<F extends URIS3>(
  M: Monad3<F>,
): <A, B, R, E>(map: Map<A, B>, key: A, insert: Kind3<F, R, E, B>) => Kind3<F, R, E, B>

export function createGetOrInsert<F extends URIS4>(
  M: Monad4<F>,
): <A, B, S, R, E>(map: Map<A, B>, key: A, insert: Kind4<F, S, R, E, B>) => Kind4<F, S, R, E, B>
