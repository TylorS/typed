...
export function createNamespaceDisposable<F>(
  M: FromIO<F>,
): Shared<F, typeof NAMESPACE_DISPOSABLE, SettableDisposable>

export function createNamespaceDisposable<F>(M: FromIO<F>) {
  return createShared<F>()(NAMESPACE_DISPOSABLE, M.fromIO(settable), EqStrict)
}
