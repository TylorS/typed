...
export function usingGlobal<F extends URIS2>(
  ...
  <E, A>(hkt: Kind2<F, E & CurrentNamespace, A>): Kind2<F, E, A>
...
export function usingGlobal<F extends URIS3>(
  ...
  <R, E, A>(hkt: Kind3<F, R & CurrentNamespace, E, A>): Kind3<F, R, E, A>
...
export function usingGlobal<F extends URIS3, E>(
  ...
  <R, A>(hkt: Kind3<F, R & CurrentNamespace, E, A>): Kind3<F, R, E, A>
...
export function usingGlobal<F extends URIS4>(
  ...
  <S, R, E, A>(hkt: Kind4<F, S, R & CurrentNamespace, E, A>): Kind4<F, S, R, E, A>
